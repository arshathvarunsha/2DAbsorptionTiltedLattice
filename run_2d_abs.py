...
i = kx[int(sys.argv[1])] # Get the index from command line argument or default to 0
...
for k in kx:
    ...
    if len(fout) > 0:
        ...
        print(f"Running simulation for initState={initState}, initKy={i} in folder {fold}")
        os.chdir(fold)
